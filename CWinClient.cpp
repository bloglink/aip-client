...
/******************************************************************************
  ...
  * brief:      更新显示
******************************************************************************/
void CWinClient::WinUpdate(QByteArray msg)
{
    QString Item = msg;
...
/******************************************************************************
  ...
  * brief:      本地下载
******************************************************************************/
void CWinClient::TcpFileLocalGet()
{
...
/******************************************************************************
  ...
  * brief:      本地上传
******************************************************************************/
void CWinClient::TcpFileLocalPut()
{
...
/******************************************************************************
  ...
  * brief:      客户下载
******************************************************************************/
void CWinClient::TcpFileClientGet()
{
...
/******************************************************************************
  ...
  * brief:      客户上传
******************************************************************************/
void CWinClient::TcpFileClientPut()
{
    int ret = ui->tabTcp->currentRow();
    if (ret < 0)
        return;
...
/******************************************************************************
  ...
  * brief:      退出保存
******************************************************************************/
void CWinClient::closeEvent(QCloseEvent *e)
{
    DatSave();
    tcp->quit();
    tcp->wait();
